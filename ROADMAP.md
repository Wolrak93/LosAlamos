...
- [x] Task 2: Bitboard Engine — Board-Repräsentation
...
- [x] Task 9: Integration & Test-Suite
      - Engine ↔ GUI-Verbindung
      - Vollständige pytest-Abdeckung für Engine und Bots

### Cycle 2 — Stärkere Bots ✅

- [x] Evaluierungsfunktionen (Material, Positionstabellen, Mobilität)
- [x] Minimax mit Alpha-Beta-Pruning
- [x] Monte-Carlo Tree Search (MCTS)
- [x] Mehrere benannte Bot-Persönlichkeiten
